...
import { getShowById } from "../service/seatingService";
    ...
    <div className="seat-background-container">
      ...
      <div className="seat-bg-header">
        ...
        <div className="ticket-count-bg">
          ...
          {requiredSeats} {requiredSeats === 1 ? 'Ticket' : 'Tickets'}
        </div>
      </div>

      {/* Show Time Tabs */}
      <div className="show-time-tabs-bg">
        <button className="time-tab-bg">03:50 PM</button>
        <button className="time-tab-bg active">09:50 PM</button>
      </div>
